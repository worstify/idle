...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/worstify/idle

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/worstify/idle/revision/ohaux.lua"))()
